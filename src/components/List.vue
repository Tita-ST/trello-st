    ...
    <main class="border-2 p-2 w-[340px] rounded max-h-screen flex flex-col">
        <div class="flex items-center justify-between mb-4">
            ...
            <div class="flex items-center">
                ...
                <p  class="font-bold ml-4 cursor-pointer">
                    x
                </p>
            </div>
        </div>
        ...
        <div class="flex-shrink-0">
            <button  class="bg-green-500 hover:bg-green-600 text-white text-center font-bold py-1 px-8 rounded w-full">
        ...
        <div  class=" inset-0 bg-gray-600 bg-opacity-50 flex justify-center items-center">
            <!-- <div class="bg-white p-4 rounded">
                <p class="mb-4">Voulez-vous vraiment supprimer cette liste ?</p>
                <div class="flex justify-end">
                    <button  class="bg-gray-300 hover:bg-gray-400 text-black font-bold py-2 px-4 rounded mr-2">
                        Non
                    </button>
